...
//Ela apenas delega o clique para BlameCindersGame, que é quem valida:
//se o jogo terminou;
...
public class CartaVisual extends Actor {
    ...
    public CartaVisual(String nomeFrente, String nomeVerso, float x, float y, int linha, int coluna, BlameCindersGame jogo, BitmapFont fonte) {
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        String texto = revelada ? nomeFrente : nomeVerso;
        layout.setText(fonte, texto, Color.WHITE, getWidth() - 16f, Align.center, true);
        fonte.setColor(1f, 1f, 1f, color.a * parentAlpha);
        fonte.draw(
            batch,
            layout,
            getX() + 8f,
    ...
    public void setFrente(String nome) {
        this.nomeFrente = nome;
        this.frente = GerenciadorTexturas.get(nome);
    }
