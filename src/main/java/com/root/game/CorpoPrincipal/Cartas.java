...
public class Cartas extends Actor {
    ...
    public Cartas(String nomeFrente, String nomeVerso, float x, float y, int linha, int coluna, TCC_0_01 jogo, BitmapFont fonte) {

        this.nomeFrente = nomeFrente;
        this.nomeVerso = nomeVerso;
        this.frente = TextureManager.get(nomeFrente);
        this.verso = TextureManager.get(nomeVerso);
        this.fonte = fonte;
        this.linha = linha;
        this.coluna = coluna;
    ...
    public void setFrente(String nome) {
        ...
        this.frente = TextureManager.get(nome);
    }
